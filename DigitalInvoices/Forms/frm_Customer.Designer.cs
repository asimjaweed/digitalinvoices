namespace DigitalInvoices.Forms
{
    partial class frm_Customer
    {
        ...
        private void InitializeComponent()
        {
            ...
            txt_STNNo = new TextBox();
            txt_NTNNo = new TextBox();
            txt_AccNo = new TextBox();
            label11 = new Label();
            label10 = new Label();
            label9 = new Label();
            bttn_AddRecrod = new Button();
            ...
            // groupBox2
            // 
            groupBox2.Controls.Add(txt_STNNo);
            groupBox2.Controls.Add(txt_NTNNo);
            groupBox2.Controls.Add(txt_AccNo);
        ...
        private TextBox txt_STNNo;
        private TextBox txt_NTNNo;
